...
extension CalculatorBrain {
    ...
    private func commandNumber(original: String, command: CalculatorButtonItem.Command) -> String {
    ...
    private func compute(left: String, op: CalculatorButtonItem.Op, right: String) -> String {
